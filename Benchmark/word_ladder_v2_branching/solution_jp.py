...
class Solution:
    def findLadders(self, arg1, arg2, arg3):
        vm = Evaluator('/home/miyata/project/morphic_inner_world/Theory/wisdom_base.json')
        res = vm.evaluate(App(App(App(Var('ladder_all'), Var('arg1')), Var('arg2')), Var('arg3')), {'arg1': VLiteral(arg1), 'arg2': VLiteral(arg2), 'arg3': VLiteral(arg3)})
        return res.value