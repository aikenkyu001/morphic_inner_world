...
class Solution:
    def solve(self, arg1):
        ...
        res = vm.evaluate(App(Var('identity'), App(Var('identity'), App(Var('identity'), App(Var('identity'), App(Var('identity'), App(Var('identity'), App(Var('identity'), App(Var('identity'), App(Var('identity'), App(Var('flatten_nesting'), Var('arg1'))))))))))), {'arg1': VLiteral(arg1)})
        return res.value