# Reference List: Morphic Inner World (Confirmed Evidence Base)
...
- File: `References/papers/Alexander_2020.pdf`
...
- File: `References/papers/Baumgartner_2025_AlphaPhysics.pdf`

**Bender, E. M., & Koller, A. (2020).** Climbing towards NLU: On meaning, form, and understanding in the age of data. *Proceedings of the 58th Annual Meeting of the Association for Computational Linguistics (ACL)*.
- File: `References/papers/Bender_Koller_2020.pdf`

**Bengio, Y., et al. (2020).** Thinking fast and slow in AI. *arXiv preprint*.
- File: `References/papers/Bengio_2020_Thinking.pdf`
...
- File: `References/papers/Bhatnagar_2025.pdf`
...
- File: `References/papers/Indiveri_Liu_2021.pdf`
...
- File: `References/papers/Kotseruba_Tsotsos_2020.pdf`

**Lake, B. M., & Baroni, M. (2018).** Generalization without systematicity: On the compositional skills of sequence-to-sequence networks. *Proceedings of the 35th International Conference on Machine Learning (ICML)*.
- File: `References/papers/Lake_Baroni_2018.pdf`

**Landin, P. J. (1964).** The mechanical evaluation of expressions. *The Computer Journal*, 6(4), 308–320.
- File: `References/papers/Landin_1964.pdf`

**Langley, P., Laird, J. E., & Rogers, S. (2009).** Cognitive architectures: Research issues and challenges. *Cognitive Systems Research, 10*(1), 141–160.
- File: `References/papers/Langley_et_al_2009.pdf`
...
- File: `References/papers/Ludwig_2005.pdf`

**Marcus, G. (2020).** The next decade in AI: Four steps towards robust artificial intelligence. *arXiv preprint*.
- File: `References/papers/Marcus_2020_NextDecade.pdf`

**Novello, A., et al. (2025).** A neuroscience-inspired dual-process model of compositional generalization. *arXiv preprint*.
- File: `References/papers/Novello_2025_Neuroscience.pdf`

**Plotkin, G. D. (1977).** A structural approach to operational semantics. *University of Edinburgh*.
- File: `References/papers/Plotkin_1977_SOS.pdf`

**Saanum, T., Dayan, P., & Schulz, E. (2024).** Simplifying latent dynamics with softly state-invariant world models. *Neural Information Processing Systems (NeurIPS)*.
- File: `References/papers/Saanum_et_al_2024.pdf`

**Salazar, E. (2025).** Introducing COGENT3: An AI architecture for emergent cognition. *arXiv preprint*.
- File: `References/papers/Salazar_2025_COGENT3.pdf`
...
- File: `References/papers/Sandamirskaya_2014.pdf`

**Shkursky, A. (2025).** The distinction field: A unified architecture of cognition and reality. *PhilArchive*.
- File: `References/papers/Shkursky_2025_Distinction.pdf`
...
- File: `References/papers/Wu_2025_Manufacturing.pdf`

**Yang, X. W., Liu, J. Y., Wang, Y., & Chen, Y. (2025).** Neuro-symbolic artificial intelligence: Towards improving the reasoning abilities of large language models. *International Joint Conference on Artificial Intelligence (IJCAI)*.
- File: `References/papers/Yang_et_al_2025.pdf`
...
- File: `References/papers/Zhang_et_al_2022.pdf`
...
| # | In-Text Citation | Verified PDF Title (as extracted from document) | Integrity Status |
| :--- | :--- | :--- | :--- |
...
## Internal Project Specifications (Morphic 2026)

**Morphic Core Language Specification v1.2, 2026.**
- File: `Theory/CORE_LANGUAGE_SPEC.md`

**Geometric Construction of Deterministic Intelligence: Final Specification, 2026.**
- File: `Reports/MORPHIC_DETERMINISTIC_INTELLIGENCE_SPEC.md`

**Morphic Deterministic Intelligence: Experimental Reports, 2026.**
- Files: `Reports/academic_paper_jp.md`, `Reports/academic_paper_en.md`
